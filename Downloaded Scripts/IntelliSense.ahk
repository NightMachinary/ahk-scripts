...
; help file:
I_HelpHotkey = ^F1 ;Note that if you use F1, you either lose F1 for ALL apps, or you'll use ~F1, which will
; lead to the Help window being opened when used in Notepad.
...
SetTimer ActiveWindowCheck, 500
